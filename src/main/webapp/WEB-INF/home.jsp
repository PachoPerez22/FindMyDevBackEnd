...
<body id="body-pd">
    <header class="header row" id="header">  
      ...
      <h2 class="text-buscador titulo_form  col-md-8">HOME</h2>
    ...
    <div class="l-navbar" id="nav-bar" style="padding-left: 7px;padding-right: 0px;">
      <nav class="nav navbar-container" >
        ...
        <div class="row item_list">
          <div class="nav_list"> <a href="/miPerfil" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 cajaFiltro text-center">
          <h5>Encuentra a tu Devs por sus Habilidades Blandas</h5>
          <form action="/home" method="post" class="form-home">
            <select name="habilidad_blandaSeleccionada" id="habilidad_blandaSeleccionada" class="btn btn-outline-warning select-home">
                <option  selected>Categorías</option>
                <c:forEach var="listaHBlandas" items="${listaHBlandas}">
                <option value="${habilidad_blanda.id}">${nombre}</option>
                </c:forEach>
            </select>
        ...
        <div class="col-md-6  cajaFiltro text-center">
          <h5>Encuentra a tu Devs por sus Habilidades Tecnicas</h5>
          <form action="/home/habilidad_tecnica" method="post" class="form-home">
            <select name="habilidad_blandaSeleccionada" id="habilidad_blandaSeleccionada" class="btn btn-outline-warning select-home">
                <option value= "0" selected>Categorías</option>
                <option value="1">React</option>
                <option value="2">Java</option>
                <option value="1">Springt</option>
      ...
      <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
              ...
              <div class="card h-80 shadow-sm tarjeta-postulante">
                  <div class="text-center">
                      <div class="img-hover-zoom img-hover-zoom--colorize">
                          <img class="shadow" src="img/fotos/4043251-avatar-female-girl-woman_113291.png"
                  ...
                  <div class="card-body">
                      ...
                      <button type="button" class="btn btn-perfiles btn-outline-warning">Ver perfil</button>
                  </div>
              </div>
          </div>
          <!---CARDS 2-->
          <div class="col">
              <div class="card h-80 shadow-sm tarjeta-postulante">
                  <div class="text-center">
                      <div class="img-hover-zoom img-hover-zoom--colorize">
                          <img class="shadow" src="img/fotos/4043260-avatar-male-man-portrait_113269.png"
                          alt="Another Image zoom-on-hover effect">
                      </div>
                  </div>
                  <div class="card-body">
          ...
          <div class="col">
              <div class="card h-80 shadow-sm">
                  <div class="text-center">
                      <div class="img-hover-zoom img-hover-zoom--colorize">
                          <img class="shadow" src="img/fotos/pngegg (1).png"
                              alt="Another Image zoom-on-hover effect">
                      </div>
                  </div>
                  <div class="card-body">
          ...
          <div class="col">
              <div class="card h-80 shadow-sm">
                  <div class="text-center">
                      <div class="img-hover-zoom img-hover-zoom--colorize">
                          <img class="shadow" src="img/fotos/pngegg.png"
                              alt="Another Image zoom-on-hover effect">
                      </div>
                  </div>
                  <div class="card-body">
